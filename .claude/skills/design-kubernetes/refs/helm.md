...
> Best practices for designing maintainable, reusable Helm charts.
...
kubeVersion: ">=1.26.0" # Kubernetes version constraint
...
home: https://github.com/org/my-api
sources:
...
```yaml
# Top-level: flat over deep nesting
replicaCount: 3
...
# Probes with configurable paths
probes:
  liveness:
    enabled: true
    path: /health/live
    ...
    "image": {
      ...
      "properties": {
        ...
        "tag": {
          ...
          "description": "Image tag (not 'latest')"
        },
        "pullPolicy": {
          "type": "string",
