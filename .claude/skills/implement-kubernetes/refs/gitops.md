...
|---------|---------|---------|
| UI | Rich web dashboard | None (CLI) |
| Learning curve | Lower | Higher |
| Resource usage | ~500MB | ~100MB |
| Multi-tenancy | Application-level RBAC | Kubernetes RBAC |
| Best for | Developer experience | Platform engineering |

**Default:** Argo CD for most teams; Flux for platform teams or resource-constrained.
...
flux bootstrap github \
  --owner=org --repository=infrastructure \
